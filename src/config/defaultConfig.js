...
export const defaultConfig = {
  ...
  strategyLayout: {
    ...
    coachAchievements: {
      ...
      sectionMargin: '',
      achievements: [
        { value: '150+', description: 'Helped over 150+ business owners grow with clarity, confidence.', icon: 'groups' },
        { value: '10x', description: 'Clients have scaled their businesses up to 10x with proven strategies.', icon: 'trending_up' },
        { value: '15+', description: 'Over a decade of experience in business transformation.', icon: 'schedule' },
        { value: '450+', description: '450+ Business Consultations done for inspiring young entrepreneurs.', icon: 'handshake' },
      ],
      iconBg: '',
      iconColor: '',
      cardBg: '',
