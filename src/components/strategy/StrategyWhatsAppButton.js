...
export function StrategyWhatsAppButton() {
  return (
    <div
      className="fixed z-[60] bottom-[5.5rem] sm:bottom-[6rem] right-5 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 mb-4"
    >
      {/* Pulsing Outer Ring */}
      <span
        className="absolute inset-0 rounded-full w-full h-full animate-ping opacity-75"
        style={{ backgroundColor: '#25d36520' }}
      ></span>
